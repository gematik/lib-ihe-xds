...
public enum EventCode implements CodeInterface {
  ...
  EDMP_DM2("01", CodeSystem.DMP, "DM2"),
  EDMP_BRK("02", CodeSystem.DMP, "BRK"),
  EDMP_KHK("03", CodeSystem.DMP, "KHK"),
  EDMP_DM1("04", CodeSystem.DMP, "DM1"),
  EDMP_ASTHMA("05", CodeSystem.DMP, "Asthma"),
  EDMP_COPD("06", CodeSystem.DMP, "COPD"),
  EDMP_HI("07", CodeSystem.DMP, "HI"),
  EDMP_DEPRESSION("08", CodeSystem.DMP, "Depression"),
  EDMP_CR("09", CodeSystem.DMP, "Rueckenschmerz"),
  EDMP_RHEUMA("10", CodeSystem.DMP, "Rheuma"),
  EDMP_OST("11", CodeSystem.DMP, "Osteoporose"),
