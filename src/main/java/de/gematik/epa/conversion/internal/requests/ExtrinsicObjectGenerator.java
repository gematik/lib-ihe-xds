...
public class ExtrinsicObjectGenerator {
  ...
  public static void fillExtrinsicObject(
    ...
    extrinsicObject.setHome(recordIdentifier.getHomeCommunityId());
    ...
    ExternalIdentifierFactory.forDocumentEntry(
        extrinsicObject, document, recordIdentifier.getInsurantId());
  }
  ...
  public static ExtrinsicObjectType createExtrinsicObject(
      DocumentInterface document, RecordIdentifier recordIdentifier, String documentId) {
    var extrinsicObject = toExtrinsicObject(documentId);
    fillExtrinsicObject(extrinsicObject, document, recordIdentifier);
    return extrinsicObject;
  }
