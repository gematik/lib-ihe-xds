    ...
    extends RegistryRequestType
{
    ...
    public RemoveObjectsRequest withAdhocQuery(AdhocQueryType value) {
        setAdhocQuery(value);
        return this;
    }

    public RemoveObjectsRequest withObjectRefList(ObjectRefListType value) {
        setObjectRefList(value);
        return this;
    }

    public RemoveObjectsRequest withDeletionScope(String value) {
        setDeletionScope(value);
        return this;
    }

    @Override
    public RemoveObjectsRequest withRequestSlotList(SlotListType value) {
        setRequestSlotList(value);
        return this;
    }

    @Override
    public RemoveObjectsRequest withId(String value) {
        setId(value);
        return this;
    }

    @Override
    public RemoveObjectsRequest withComment(String value) {
        setComment(value);
        return this;
    }
    ...
    public boolean equals(Object object) {
        ...
        final RemoveObjectsRequest that = ((RemoveObjectsRequest) object);
        {
        ...
        {
            String leftDeletionScope;
            leftDeletionScope = this.getDeletionScope();
            String rightDeletionScope;
            rightDeletionScope = that.getDeletionScope();
            if (this.deletionScope!= null) {
                if (that.deletionScope!= null) {
                    if (!leftDeletionScope.equals(rightDeletionScope)) {
                        return false;
                    }
                } else {
                    return false;
    ...
    public int hashCode() {
        ...
        {
            currentHashCode = (currentHashCode* 31);
            String theDeletionScope;
            theDeletionScope = this.getDeletionScope();
            if (this.deletionScope!= null) {
                currentHashCode += theDeletionScope.hashCode();
            }
        }
