    ...
    extends SimpleFilterType
{
    ...
    public DateTimeFilterType withValue(XMLGregorianCalendar value) {
        setValue(value);
        return this;
    }

    @Override
    public DateTimeFilterType withDomainAttribute(String value) {
        setDomainAttribute(value);
        return this;
    }

    @Override
    public DateTimeFilterType withComparator(String value) {
        setComparator(value);
        return this;
    }

    @Override
    public DateTimeFilterType withNegate(Boolean value) {
        setNegate(value);
        return this;
    }
    ...
    public boolean equals(Object object) {
        ...
        final DateTimeFilterType that = ((DateTimeFilterType) object);
        {
            XMLGregorianCalendar leftValue;
            leftValue = this.getValue();
            XMLGregorianCalendar rightValue;
