...
public class InternationalStringType {
    ...
    public InternationalStringType withLocalizedString(LocalizedStringType... values) {
        if (values!= null) {
            for (LocalizedStringType value: values) {
                getLocalizedString().add(value);
            }
        }
        return this;
    }

    public InternationalStringType withLocalizedString(Collection<LocalizedStringType> values) {
        if (values!= null) {
            getLocalizedString().addAll(values);
        }
        return this;
    }
    ...
    public boolean equals(Object object) {
        ...
        final InternationalStringType that = ((InternationalStringType) object);
        {
            List<LocalizedStringType> leftLocalizedString;
            leftLocalizedString = (((this.localizedString!= null)&&(!this.localizedString.isEmpty()))?this.getLocalizedString():null);
            List<LocalizedStringType> rightLocalizedString;
            rightLocalizedString = (((that.localizedString!= null)&&(!that.localizedString.isEmpty()))?that.getLocalizedString():null);
            if ((this.localizedString!= null)&&(!this.localizedString.isEmpty())) {
                if ((that.localizedString!= null)&&(!that.localizedString.isEmpty())) {
                    if (!leftLocalizedString.equals(rightLocalizedString)) {
                        return false;
                    }
                } else {
                    return false;
    ...
    public int hashCode() {
        int currentHashCode = 1;
        {
            ...
            if ((this.localizedString!= null)&&(!this.localizedString.isEmpty())) {
                currentHashCode += theLocalizedString.hashCode();
            }
        }
