    ...
    extends SimpleFilterType
{
    ...
    public BooleanFilterType withValue(boolean value) {
        setValue(value);
        return this;
    }

    @Override
    public BooleanFilterType withDomainAttribute(String value) {
        setDomainAttribute(value);
        return this;
    }

    @Override
    public BooleanFilterType withComparator(String value) {
        setComparator(value);
        return this;
    }

    @Override
    public BooleanFilterType withNegate(Boolean value) {
        setNegate(value);
        return this;
    }
    ...
    public boolean equals(Object object) {
        ...
        final BooleanFilterType that = ((BooleanFilterType) object);
        {
            boolean leftValue;
            leftValue = this.isValue();
            boolean rightValue;
            rightValue = that.isValue();
    ...
    public int hashCode() {
        ...
        currentHashCode = ((currentHashCode* 31)+ super.hashCode());
        {
            ...
            currentHashCode += (theValue? 1231 : 1237);
        }
